...
class logstore_mentor2_models_testcase extends advanced_testcase {
    ...
    public function test_model_collection_get_required_fields_ok() {
        ...
        $collection = new \logstore_mentor2\models\collection([
            'name' => 'colelction1',
        ]);
    ...
    public function test_model_entity_get_required_fields_ok() {
        ...
        $entity = new \logstore_mentor2\models\entity([
            'entityid' => 0,
            'name' => 'Entity name',
            'regions' => 'Region name',
        ]);
    ...
    public function test_model_log_get_required_fields_ok() {
        ...
        $log = new \logstore_mentor2\models\log([
            'userlogid' => 1,
            'sessionlogid' => 2,
        ]);
    ...
    public function test_model_region_get_required_fields_ok() {
        ...
        $region = new \logstore_mentor2\models\region([
            'name' => 'Region name',
        ]);
    ...
    public function test_model_session_get_required_fields_ok() {
        ...
        $session = new \logstore_mentor2\models\session([
            'sessionid' => 1,
            'entitylogid' => 2,
            'subentitylogid' => 3,
    ...
    public function test_model_user_get_required_fields_ok() {
        ...
        $user = new \logstore_mentor2\models\user([
            'userid' => 1,
            'entitylogid' => 2,
            'trainer' => 0,
            'status' => 1,
