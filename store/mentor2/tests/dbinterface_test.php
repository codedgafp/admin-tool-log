...
class logstore_mentor2_database_interface_testcase extends advanced_testcase {
    ...
    public function test_add_to_log_ok() {
        ...
        $logdata = $logreflection->getValue($dbinterface);
        self::assertEmpty($logdata['log2']);
        $addtologmethod->invokeArgs($dbinterface, ['log2', 1, 'data1']);
        $logdata = $logreflection->getValue($dbinterface);
        ...
        $logdata = $logreflection->getValue($dbinterface);
        self::assertEmpty($logdata['log_history2']);
        $addtologmethod->invokeArgs($dbinterface, ['log_history2', 2, 'data2']);
        $logdata = $logreflection->getValue($dbinterface);
        ...
        $logdata = $logreflection->getValue($dbinterface);
        self::assertEmpty($logdata['session2']);
        $addtologmethod->invokeArgs($dbinterface, ['session2', 3, 'data3']);
        $logdata = $logreflection->getValue($dbinterface);
        ...
        $logdata = $logreflection->getValue($dbinterface);
        self::assertEmpty($logdata['collection2']);
        $addtologmethod->invokeArgs($dbinterface, ['collection2', 4, 'data4']);
        $logdata = $logreflection->getValue($dbinterface);
        ...
        $logdata = $logreflection->getValue($dbinterface);
        self::assertEmpty($logdata['user2']);
        $addtologmethod->invokeArgs($dbinterface, ['user2', 5, 'data5']);
        $logdata = $logreflection->getValue($dbinterface);
        ...
        $logdata = $logreflection->getValue($dbinterface);
        self::assertEmpty($logdata['region2']);
        $addtologmethod->invokeArgs($dbinterface, ['region2', 6, 'data6']);
        $logdata = $logreflection->getValue($dbinterface);
        ...
        $logdata = $logreflection->getValue($dbinterface);
        self::assertEmpty($logdata['entity2']);
        $addtologmethod->invokeArgs($dbinterface, ['entity2', 7, 'data7']);
        $logdata = $logreflection->getValue($dbinterface);
    ...
    public function test_get_log_ok() {
        ...
        // Add new log data.
        $addtologmethod->invokeArgs($dbinterface, [
            'log2', 1, 'data1',
        ]);
        $addtologmethod->invokeArgs($dbinterface, [
